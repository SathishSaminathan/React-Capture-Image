...
import CameraWidget from "../Widgets/Camera/CameraWidget";
...
let returnValue;
let defaultImageValue="http://mindandculture.org/wordpress6/wp-content/uploads/2018/07/Fotolia_188161178_XS-1.jpg";
...
class Camera extends Component {
  ...
  saveImage() {
    document
      ...
      .setAttribute("href", this.state.picData);
  }
  ...
  takePicture() {
    if (this.getPermissions()) {
      ...
      alert("Please allow the Camera Permission to Proceed..");
    }
  }
  ...
  render() {
    ...
    return (
      ...
      >
        <CameraWidget handleStartClick={this.handleStartClick} />
        <canvas
          id="canvas"
          // style={ styles.picSize }
          hidden
        />
        {/* <PhotoWidget handleSaveClick={this.saveImage} /> */}
        <EmployeDetails IsLoading={IsLoading} />
      </div>
    );
  }
}
